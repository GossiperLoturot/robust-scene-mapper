...
class GaussianSplattingTask(luigi.Task):
    resources = { "gpu_vol": 1 }
    ...
    def run(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            shutil.rmtree(gaussian_splatting_dir, ignore_errors=True)
            shutil.move(os.path.join(CONTAINER_DATA_DIR, "output"), gaussian_splatting_dir)
            ...
            with output.open_upload() as f:
                f.add(gaussian_splatting_dir, "gaussian-splatting")
